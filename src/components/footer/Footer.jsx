            ...
            <div className="top">
                <div className="chSocKhachHangMain">
                    <div className="ChamSocKhachHang">
                        <div className="name"><span>CHĂM SÓC KHÁCH HÀNG</span></div>
                        <ul>
                            <li>
                    ...
                    <div className="ChamSocKhachHang">
                        <div className="name"><span>VỀ SHOPEE</span></div>
                        <ul>
                            <li>
                                <a href="">Giới Thiệu Về Shoppe Việt Nam</a>
                            </li>
                            <li>
                                <a href="">Tuyển Dụng</a>
                            </li>
                            <li>
                                <a href="">Điểu Khoản Shopee</a>
                            </li>
                            <li>
                    ...
                    <div className="ChamSocKhachHang">
                        <div className="name"><span>THANH TOÁN</span></div>
                        <ul className='image'>
                            <li>
                                <div className='img'>
                        ...
                        <div className="name"><span>ĐƠN VỊ VẬN CHUYỂN</span></div>
                        <ul className='image'>
                            <li>
                                <div className='img'>
                                    <img src="https://downloadlogomienphi.com/sites/default/files/logos/download-logo-visa-mien-phi.jpg" alt="" />
                    ...
                    <div className="ChamSocKhachHang">
                        ...
                        <a href="" className='updateApp'>
                            ...
                            <div className="apps">
                                <img src="https://www.seekpng.com/png/full/223-2231228_app-store-apple-transprent-download-on-apple-store.png" alt="" />
                                <img src="https://www.seekpng.com/png/full/223-2231228_app-store-apple-transprent-download-on-apple-store.png" alt="" />
                                <img src="https://www.seekpng.com/png/full/223-2231228_app-store-apple-transprent-download-on-apple-store.png" alt="" />
                            </div>
                        </a>
                ...
                <div className="baoLuuVaquocGia">
                    <div className="baoLuu">@ 2022 Shoppee. Tất cả các quyền bảo lưu</div>
