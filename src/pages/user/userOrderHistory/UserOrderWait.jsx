                            ...
                            <div className='order-container'>
                                <div className="order-product--shop">
                                    ...
                                    <div className="order-product--shop__right">
                                        <div className="order-success__status" style={{ color: 'green', fontWeight: 'bold' }}>
                                            <span> <i class="fa-solid fa-truck"></i> Đã giao hàng thành công </span>
                                        </div>
                                    </div>
                                </div>
